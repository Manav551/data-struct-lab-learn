      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-gray-600">
              Interactive platform to learn data structures through practice and visualization.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/playground" className="text-gray-600 hover:text-brand-blue">
                  Playground
                </Link>
              </li>
              <li>
                <Link to="/challenges" className="text-gray-600 hover:text-brand-blue">
                  Challenges
                </Link>
              </li>
              <li>
                <Link to="/roadmap" className="text-gray-600 hover:text-brand-blue">
                  Learning Path
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/forum" className="text-gray-600 hover:text-brand-blue">
                  Forum
                </Link>
              </li>
              <li>
                <Link to="/discord" className="text-gray-600 hover:text-brand-blue">
                  Discord
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/contribute" className="text-gray-600 hover:text-brand-blue">
                  Contribute
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} DataStructLab. All rights reserved.
          </p>
